// icon:brand-github | Tabler Icons https://tablericons.com/ | Csaba Kissi
...
function GithubIcon(props) {
  return (
    <svg
      ...
      width="2em"
      {...props}
      className="transform transition-transform duration-300 hover:animate-wobble text-black dark:text-white"
    >
