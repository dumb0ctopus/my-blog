export default function PrivacyPolicy() {
  return (
    <main className="flex items-center justify-center px-4 mt-24 dark:bg-gray-950 dark:text-white">
      <div className="max-w-3xl bg-white dark:bg-gray-950 p-8 rounded-lg text-gray-800 dark:text-gray-200">
        <h1 className="sm:text-3xl text-lg font-bold mb-6 text-center">Privacy Policy</h1>
        ...
        <section className="mb-4">
          <h2 className="sm:text-2xl font-semibold mt-6 mb-2">Data Security</h2>
          <p>
        ...
        <section className="mb-4">
          <h2 className="sm:text-2xl font-semibold mt-6 mb-2">Contact Us</h2>
          <p>
